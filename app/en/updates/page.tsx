...
// Na home internacional a URL limpa é "/updates" (rewrite por host em
// next.config.ts). Em dev (localhost) acesse "/en/updates" diretamente.
const BASE = "/updates";

export const metadata: Metadata = {
  metadataBase: new URL(EN_SITE_URL),
  title: "Updates · Save Suspiro",
  description: "Follow Suspiro's recovery and treatment updates.",
  alternates: { canonical: "/updates" },
};

export default function UpdatesPage() {
  const itens = listarAtualizacoes("en");
  const t = TEXTOS.en;
