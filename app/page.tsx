...
import { Gift, Ticket, TiktokLogo } from "@phosphor-icons/react/dist/ssr";
  ...
  return (
    <footer className="mt-auto flex flex-col items-center gap-3 pt-6 text-center text-xs text-mauve/70">
      <div className="flex items-center gap-3">
        ...
        <a
          href="https://www.tiktok.com/@oi.belbel?_r=1&_t=ZS-97T3FXn6Wu4"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="TikTok do Lar Amorinha"
          className="flex h-10 w-10 items-center justify-center rounded-full bg-rose-deep text-white transition-opacity hover:opacity-80"
        >
          <TiktokLogo weight="fill" size={20} aria-hidden />
        </a>
      </div>
      <p>
